...
public class SelectionSortTest {
  ...
  @Autowired private SelectionSort selectionSort;
  ...
  void testEmptySort(List<Integer> testData) {
    List<Integer> sortedData = selectionSort.sorting(testData);
  ...
  void testDataWithRandomData() {
    ...
    List<Integer> sortedData = selectionSort.sorting(unSortedData);
    System.out.println(sortedData.toString());
